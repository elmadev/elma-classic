...
void render_bike(pic8* dest, bool has_flag, vect2 bottomleft_corner, const motorst* mot,
    ...
    // (temp, this will be a renderer method)
    auto bike_draw_affine_pic = [&](const pic8* affine, unsigned char transparency, vect2 u,
                                    vect2 v, vect2 r) {
        ...
        draw_affine_pic(dest, affine, transparency, u, v, r);
    };
