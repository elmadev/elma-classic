...
void sound_engine_init() {
    ...
    WavBank[(int)WavEvent::RIGHT_VOLT] = new wav("ugras.wav", 0.34); // jump
    WavBank[(int)WavEvent::LEFT_VOLT] = WavBank[(int)WavEvent::RIGHT_VOLT];
    ...
    SoundMotorIgnition =
        new wav("harl.wav", volume, 0, HARL_MAX_INDEX_1 + WAV_FADE_LENGTH); // ?Harley
